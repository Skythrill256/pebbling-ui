      ...
      <div className="w-full flex flex-col px-4 md:px-52 ">
        <div className="w-full flex flex-col space-y-4 text-center mb-12" >
          <div className="space-y-3 text-white">
            <span className="text-3xl font-medium tracking-tighter sm:text-4xl md:text-5xl text-white "style={{
        ...
        fontStyle: 'italic',
            ...
            <p className="mx-auto max-w-[700px] text-white mt-3 md:text-xl"  style={{
        ...
        fontFamily: 'inter, sans-serif',
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem
              value="item-1"
              className="rounded-lg bg-white/30 backdrop-blur-md shadow-sm border border-white/30 overflow-hidden"
            >
              <AccordionTrigger className="text-lg font-normal px-6 py-4 text-white  hover:no-underline flex items-center justify-between">
                What is Pebbling AI?
                
              </AccordionTrigger>
              <AccordionContent className="text-white  px-6 pb-6 pt-2">
            ...
            <AccordionItem
              ...
              className="rounded-lg bg-white/30 backdrop-blur-md shadow-sm border border-white/30 overflow-hidden"
            >
              <AccordionTrigger className="text-lg font-medium px-6 py-4 text-white  hover:no-underline transition-colors flex items-center justify-between">
