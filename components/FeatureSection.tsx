...
const FeatureCard = ({ title, description, icon: Icon, index, category }: FeatureCardProps) => {
  ...
  return (
    <motion.div
      ref={cardRef}
      className="relative group rounded-xl bg-primary p-6 sm:p-8 border border-border/50 overflow-hidden"
    ...
    >
      ...
      {/* Category label */}
      <div className="mb-4 inline-flex items-center bg-primary/80 text-xs uppercase tracking-wider text-purple-600 font-medium">
        {category}
      </div>
      ...
      <div className="mb-6 relative">
        ...
        />
        <div className="relative bg-primary/70 backdrop-blur-sm rounded-full p-3 inline-flex">
...
const SectionTitle = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <motion.h2
      ref={ref}
      className="text-4xl font-medium tracking-tight text-purple-900 sm:text-5xl md:text-6xl"style={{
    ...
    <section className="w-full py-24 bg-primary relative overflow-hidden" ref={containerRef}>
      ...
      <div className="container px-4 md:px-6 mx-auto max-w-6xl relative z-10">
        ...
        fontStyle: 'italic',
              ...
              Built for the future of agent technology
            </span>
          </h2>
